            ...
            >
              {displayCourses.map((course, idx) => (
                <div 
                  ...
                  className="shrink-0 w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(25%-0.75rem)]"
                >
                  <div className="bg-white border border-gray-100 rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)] transition-all duration-300 text-left flex flex-col h-full group">
                    ...
                    <div className="p-3 pb-0">
                      <div className="relative h-[200px] w-full rounded-[16px] overflow-hidden">
                        <Image 
                          src={course.image} 
                          alt={course.title} 
                          fill
                    ...
                    <div className="p-5 pb-4 flex flex-col flex-1">
                      ...
                      {/* Description */}
                      <p className="text-[12px] font-medium text-gray-500 leading-relaxed mb-3 line-clamp-2 pr-2">
                        {course.description}
                      </p>
