...
export const metadata: Metadata = getPageMetadata("termsConditions");

export default function TermsConditionsPage() {
  const templateData = data.categories.Education.templateComponents["template-1"];
  const sections = templateData.sections;
  const pageData = templateData.pages.termsConditions;
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 overflow-x-clip">
      ...
      <main>
        ...
        <LegalContent data={sections.legal.termsConditions} />
