...
export const metadata: Metadata = getPageMetadata("enquiry");

export default function EnquiryPage() {
  const templateData = data.categories.Education.templateComponents["template-1"];
  const sections = templateData.sections;
  const pageData = templateData.pages.enquiry;
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] font-sans text-gray-900 overflow-x-clip">
      ...
      <main>
        <Breadcrumb data={pageData.breadcrumb} waveColor="#fafbfc" />
        <Enquiry data={sections.enquiry} />
      </main>
